    ...
    <div class="container">
        ...
        <table class="table table-bordered">
           ...
           <%-- <c:forEach var="libraryElement" items="${libraryElementsList}">
                <tr>
                   &lt;%&ndash; <td><c:out value="${libraryElement.getLibraryElementId()}" /></td>
                    ...
                    <td><c:out value="${libraryElement.getStatusId()}" /></td>&ndash;%&gt;
                       &lt;%&ndash; <td><a href="edit?id=<c:out value='${1}' />">Edit</a>
                            &nbsp;&nbsp;&nbsp;&nbsp; <a
                                    href="delete?id=<c:out value='${1}' />">Delete</a></td>&ndash;%&gt;
                </tr>
            </c:forEach>--%>
